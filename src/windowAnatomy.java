...
public class windowAnatomy extends JFrame implements ActionListener {
	...
	private ArrayList<Structure> selection;
	...
	public void actionPerformed(ActionEvent arg0) {
	    ...
	    ArrayList<Structure> selection = new ArrayList<Structure>();
	    // Get all the selected items using the indices
	    for (int i = 0; i < selectedIx.length; i++) {
	    	String item = (String) list.getModel().getElementAt(selectedIx[i]);
	    	selection.add(aGEM.search(item));
	    }
	    wasperformed = true;
	...
	public ArrayList<Structure> getResults(){
